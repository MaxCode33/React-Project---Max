    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="flex flex-wrap justify-center items-center gap-5 mt-2 dark:text-white">
                {favoriteCards.map((c) => (
                    <div key={c._id} className="flex flex-col justify-center items-center p-5 rounded-md text-center bg-blue-400 m-2 dark:bg-blue-900 relative drop-shadow-md favorite-cards-style">
