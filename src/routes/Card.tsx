...
const Card = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center gap-5 mt-2 ">
            {card && (
                <div className="flex flex-col justify-center items-center p-5 rounded-md text-center bg-blue-400 m-2  dark:bg-blue-900 dark:text-white drop-shadow-md card-style">
                    <img
                    ...
                    />
                    <div className="mt-1">
                        <h2 style={{ color: "#000000" }} className="text-l px-1 py-0.5 font-bold">{card.title}</h2>
                        <p >{card.subtitle}</p>
                        <p >{card.phone}</p>
                        <p >{card.email}</p>
                        <p>
            ...
            <div className=" flex flex-wrap justify-center ">
                ...
                {card && card.address && (
                    ...
                    <div className=" bg-blue-400 m-2 dark:bg-blue-900 p-5 rounded-md drop-shadow-md  dark:text-white w-80 ">
                        <h3 style={{ color: "#000000" }} className="text-l  py-0.5 font-bold">Address :</h3>
                ...
                <div className="text-sm text-center w-80 bg-blue-400 m-2 dark:bg-blue-900 p-5 rounded-md drop-shadow-md  dark:text-white "><h3 style={{ color: "#000000" }} className="text-l px-1 py-0.5 font-bold">Description : </h3> {card?.description}</div>
            </div>
        </div>
    );
};
